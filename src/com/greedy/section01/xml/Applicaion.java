...
public class Applicaion {
	...
	private static void trimSubmMenu() {
		...
		do {
			...
			System.out.println("1. 매뉴 혹은 카테고리 코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, 검색조건이 없는 경우 전체 검색 ");
	...
	private static Map<String, Object> inputSearchCriteriaMap() {
		...
		if("category".equals(condition)) {
			...
			System.out.println("검색할 이름 코드 입력 : ");
